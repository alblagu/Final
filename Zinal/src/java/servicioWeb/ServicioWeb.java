...
//	}
	...
	*********************************************************************
	...
	public void addNuevoUsuario(String json) throws ClassNotFoundException, SQLException {
		...
		GestorUsuario.createUsuario(new Usuario(usuario.getString("dni"), Hash.sha1(usuario.getString("password")), usuario.getString("nombre")+" "+ usuario.getString("apellidos"),false, usuario.getString("telefono")));
	}
